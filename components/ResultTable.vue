<template>
  <div id="results" class="overflow-x-auto">
    ...
    >
      <div class="w-full lg:w-5/6">
        <div class="bg-white shadow-md rounded my-6">
          <table class="min-w-max w-full table-auto text-right">
            <tr class="text-sm leading-normal hover:bg-gray-100">
              <th class="w-64 uppercase py-3 px-6 border-t border-gray-200">
                Số tiền vay
              </th>
              <td class="py-3 px-6 border-t border-gray-200">
      ...
      <div class="w-full lg:w-5/6">
        <div
          class="bg-white shadow-md rounded my-6 overflow-y-auto scrollbar-w-2 scrollbar-track-gray-lighter scrollbar-thumb-rounded scrollbar-thumb-gray scrolling-touch lg:max-h-max min-h-40"
        >
          <table class="min-w-max w-full table-auto border-collapse">
            <thead>
              <tr class="uppercase text-sm leading-normal">
                <th
                  class="bg-gray-200 text-gray-700 z-20 sticky top-0 py-3 px-6 text-center"
                >
                  Tháng thứ
                </th>
                <th
